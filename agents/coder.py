...
CODER_TOOLS_SCHEMA = FILE_TOOLS_SCHEMA + EXEC_TOOLS_SCHEMA + GIT_TOOLS_SCHEMA
CODER_TOOL_EXECUTOR = {**TOOL_EXECUTOR, **EXEC_TOOL_EXECUTOR, **GIT_TOOL_EXECUTOR}
...
CODE_SYSTEM_PROMPT = (
    ...
    "'git_diff', 'git_log', 'web_search', 'fetch_url', 'whois_lookup'.\n\n"
